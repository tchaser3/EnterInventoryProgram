...
namespace EnterInventory
{
    class ProcessBatchClass
    {
        ...
        public void UpdateInventoryTables()
        {
            ...
            try
            {
                ...
                if (intWIPNumberOfRecords > -1)
                {
                    ...
                    MainWindow.TheFindSessionByemployeeID = TheInventoryWIPClass.FindSessionByEmployeeID(MainWindow.TheVerifyLogonDataSet.VerifyLogon[0].EmployeeID);

                    MainWindow.gintSessionID = MainWindow.TheFindSessionByemployeeID.FindSessionByEmployeeID[0].SessionID;
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "Enter Inventory \\ Process Patch Class \\ Update Tables " + Ex.Message);
        ...
        private bool UpdateInventoryInfo(int intPartID, int intWarehouseID, int intQuantity)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "Enter Inventory // Process Patch Class // Update Inventory Info " + Ex.Message);
        ...
        private bool UpdateCharterWarehouseInfo(int intPartID, int intWarehouseID, int intQuantity)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "Enter Inventory // Process Batch Class // Update Charter Warehouse Info " + Ex.Message);
